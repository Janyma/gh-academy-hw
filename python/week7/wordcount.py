...
def print_words(filename):
  with open(filename, "r") as file:
    content = file.read() #the file will be read
    print(content)
    for i in string.punctuation:
        content = content.replace(i, "") #remove unneeded chars

    a=content.lower() #lowercase
    content1= a.split() #split to words
    content1.sort() #sort the strings
    dictionary={}
    for i in content1:
  ...
  with open(filename, "r") as file:
    ...
    for i in content1:
      if i not in dictionary:
        ...
        dictionary[i]+=1
    sorted_data_by_value = sorted(dictionary.items(), key=itemgetter(1), reverse=True)
    for i in range(20):
      print("TOP", sorted_data_by_value[i])
    #print("Print top: ", dictionary_end)
      

    print("Sorted value", sorted_data_by_value)
print(print_top("/Users/zhanylmyrzasanzharbekova/gh-academy-hw/gh-academy-hw-1/python/week7/alice.txt"))
                 

print(print_words("/Users/zhanylmyrzasanzharbekova/gh-academy-hw/gh-academy-hw-1/python/week7/small.txt")) 
#def print_top():
